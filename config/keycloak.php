...
return [
    'host' => env('KEYCLOAK_HOST', 'localhost'),

    'client_secret_key' => env('KEYCLOAK_CLIENT_SECRET_KEY', ''),

    'client_id' => env('KEYCLOAK_CLIENT_ID', ''),

    'admin_api_client_secret_key' => env('KEYCLOAK_CLIENT_ADMIN_API_SECRET_KEY', ''),

    'realm_public_key' => env('KEYCLOAK_REALM_PUBLIC_KEY', null),

    'realm_name' => env('KEYCLOAK_REALM_NAME', 'master'),
    ...
    'use_https' => env('KEYCLOAK_USE_HTTPS', true),

    'access_token_ttl' => env('KEYCLOAK_ACCESS_TOKEN_TTL', null)
];
